...
node scripts/gen-nav.js 'content/docs/v3.1/TOC.md' 'data/docs_v31_toc.json' '/docs'
...
node scripts/gen-nav.js 'content/docs-cn/v3.1/TOC.md' 'data/docs_cn_v31_toc.json' '/docs-cn'
